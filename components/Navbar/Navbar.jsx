      ...
      <div className="offcanvas-body">
        <ul className="navbar-nav justify-content-end flex-grow-1 pe-3 navbar_text">
          <li className="nav-item">
            <a className="navbar_text active " aria-current="page" href="#">Home</a>
          </li>
          <li className="nav-item navbar_text">
            <a className="navbar_text" href="#">Link</a>
          </li>
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu navbar_text" aria-labelledby="offcanvasNavbarDropdown">
              <li><a className=" navbar_text" href="#">Action</a></li>
              <li><a className="navbar_text" href="#">Another action</a></li>
              <li>
                <hr className="dropdown-divider"/>
              </li>
              <li><a className="dropdown-item navbar_text" href="#">Something else here</a></li>
            </ul>
          </li>
        </ul>
